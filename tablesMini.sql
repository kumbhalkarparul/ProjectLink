...
Password varchar(20)
 ...
 insert into  mini.ManagerLogin values(200001,'John','John','John')
 insert into  mini.ManagerLogin values(200002,'Paul','Paul','Paul')
 insert into  mini.ManagerLogin values(200003,'Priya','Priya','Priya')
 insert into  mini.ManagerLogin values(200004,'Riya','Riya','Riya')
...
insert into mini.Agentlogin values('RedBus','agent','agent')
...
as
begin
 select * from  mini.TravelRequest where CurrentStatus='Manager Approved' or CurrentStatus='Ticket Confirmed' or CurrentStatus='Tickets Not available'
end
...
drop proc mini.updateStatusByManager
alter procedure mini.updateStatusByManager
(
@CurrentStatus varchar(150),
@EmployeeId int
)
as
begin
 update mini.TravelRequest set CurrentStatus= @CurrentStatus where EmployeeId=@EmployeeId and CurrentStatus IS NULL
end
...
alter procedure mini.updateStatusByTravelAgent
(
@CurrentStatus varchar(150),
@RequestId int
)
as
begin
 update mini.TravelRequest set CurrentStatus= @CurrentStatus where RequestId =@RequestId and CurrentStatus = 'manager approved'
end
